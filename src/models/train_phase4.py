"""
Train Phase 4: Phase 3 + Contextual Features
"""
import numpy as np
import pandas as pd
...
def train_phase4_model():
    """Train Phase 4: Phase 3 + Contextual"""
    ...
    model_path = model_dir / "phase4_contextual.json"
    model.save_model(str(model_path))

    with open(model_dir / "phase4_features.txt", "w") as f:
